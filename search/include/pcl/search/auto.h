...
namespace pcl {
  namespace search {
    ...
    /**
      ...
      */
    //template<typename PointT>
    //pcl::search::Search<PointT> * autoSelectMethod(const typename pcl::PointCloud<PointT>::ConstPtr& cloud, const pcl::IndicesConstPtr& indices, const & point_representation, bool sorted_results, Purpose purpose = Purpose::undefined);
  } // namespace search
} // namespace pcl
